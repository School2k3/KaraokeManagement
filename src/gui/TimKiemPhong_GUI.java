...
public class TimKiemPhong_GUI extends JPanel implements ActionListener, MouseListener {
	...
	public TimKiemPhong_GUI() throws Exception {
		 ...
		 */
				...
				cmbXepTrangThai.addItem("Đặt trước");
				...
				add(scrTimPhong = new JScrollPane(tblTimKiemPhong = new JTable(model),
				...
				tblTimKiemPhong.getTableHeader().setFont(new Font(Font.SANS_SERIF, Font.BOLD, 23));
				tblTimKiemPhong.setFont(new Font("SansSerif", Font.PLAIN, 20));
				tblTimKiemPhong.setRowHeight(50);
				add(scrTimPhong);
				loadDanhSachPhong();
				docLieuLenTable();
	...
	private void them() throws Exception{
		...
		if(!ma.equals("") && !ten.equals("") && !stt.equals("") && !loai.equals("") && !giaText.equals("")){ //tìm by all
			dsPhong= phong_DAO.getListPhongByAll(ma, ten, gia, loai, stt);
		}else if (!ma.equals("") && !ten.equals("") && stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Mã tên giá loại 
			dsPhong= phong_DAO.getListPhongByMaTenGiaVaLoai(ma, ten, gia, loai);
		}else if (!ma.equals("") && !ten.equals("") && !stt.equals("") && loai.equals("") && !giaText.equals("")) { //Mã tên giá trạng thái
			dsPhong= phong_DAO.getListPhongByMaTenGiaVaTrangThai(ma, ten, gia, stt);
		}else if (!ma.equals("") && !ten.equals("") && !stt.equals("") && !loai.equals("") && giaText.equals("")) { //Mã tên loại trạng thái
			dsPhong= phong_DAO.getListPhongByMaTenLoaiVaTrangThai(ma, ten, stt, loai);
		}else if (!ma.equals("") && ten.equals("") && !stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Mã giá loại trạng thái
			dsPhong= phong_DAO.getListPhongByMaGiaLoaiVaTrangThai(ma, loai, gia, stt);
		}else if (ma.equals("") && !ten.equals("") && !stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Tên giá loại trạng thái
			dsPhong= phong_DAO.getListPhongByTenGiaLoaiVaTrangThai(loai, ten, gia, stt);
		}else if (!ma.equals("") && !ten.equals("") && stt.equals("") && loai.equals("") && !giaText.equals("")) { //Mã tên giá
			dsPhong= phong_DAO.getListPhongByMaTenvaGia(ma, ten, gia);
		}else if (!ma.equals("") && !ten.equals("") && stt.equals("") && !loai.equals("") && giaText.equals("")) { //Mã tên loại
			dsPhong= phong_DAO.getListPhongByMaTenVaLoai(ma, loai, ten);
		}else if (!ma.equals("") && !ten.equals("") && !stt.equals("") && loai.equals("") && giaText.equals("")) { //Mã tên trạng thái
			dsPhong= phong_DAO.getListPhongByMaTenVaTrangThai(ma, stt, ten);
		}else if (!ma.equals("") && ten.equals("") && stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Mã giá loại
			dsPhong= phong_DAO.getListPhongByMaGiaVaLoai(ma, loai, gia);
		}else if (!ma.equals("") && ten.equals("") && !stt.equals("") && loai.equals("") && !giaText.equals("")) {  //Mã giá trạng thái   
			dsPhong= phong_DAO.getListPhongByMaGiaVaTrangThai(ma, stt, gia);
		}else if (!ma.equals("") && ten.equals("") && !stt.equals("") && !loai.equals("") && giaText.equals("")) { //Mã loại trạng thái
			dsPhong= phong_DAO.getListPhongByMaLoaiVaTrangThai(ma, stt, loai);
		}else if (ma.equals("") && !ten.equals("") && stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Tên giá loại 
			dsPhong= phong_DAO.getListPhongByTenGiaVaLoai(ten, loai, gia);
		}else if (ma.equals("") && !ten.equals("") && !stt.equals("") && loai.equals("") && !giaText.equals("")) { //Tên giá trạng thái
			dsPhong= phong_DAO.getListPhongByTenGiaVaTrangThai(ten, stt, gia);
		}
		else if (ma.equals("") && !ten.equals("") && !stt.equals("") && !loai.equals("") && giaText.equals("")) { //Tên loại trạng thái
			dsPhong= phong_DAO.getListPhongByTenLoaiVaTrangThai(ten, stt, loai);
		}
		else if (ma.equals("") && !ten.equals("") && stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Giá loại trạng thái
			dsPhong= phong_DAO.getListPhongByGiaLoaiVaTrangThai(gia, stt, loai);
		}else if (!ma.equals("") && !ten.equals("") && stt.equals("") && loai.equals("") && giaText.equals("")) { // Mã và tên
			dsPhong= phong_DAO.getListPhongByMavaTen(ma, ten);
		}else if (!ma.equals("") && ten.equals("") && stt.equals("") && loai.equals("") && !giaText.equals("")) { //Mã và giá
			dsPhong= phong_DAO.getListPhongByMavaGia(ma, gia);
		}else if (!ma.equals("") && ten.equals("") && stt.equals("") && !loai.equals("") && giaText.equals("")) { //Mã và loại
			dsPhong= phong_DAO.getListPhongByMavaLoai(ma, loai);
		}else if (!ma.equals("") && ten.equals("") && !stt.equals("") && loai.equals("") && giaText.equals("")) { //Mã và trạng thái
			dsPhong= phong_DAO.getListPhongByMaVaTrangThai(stt, ma);
		}else if (ma.equals("") && !ten.equals("") && stt.equals("") && loai.equals("") && !giaText.equals("")) { //Tên và giá
			dsPhong= phong_DAO.getListPhongByTenvaGia(ten, gia);
		}else if (ma.equals("") && !ten.equals("") && stt.equals("") && !loai.equals("") && giaText.equals("")) { //Tên và loại
			dsPhong= phong_DAO.getListPhongByTenVaLoai(ten, loai);
		}else if (ma.equals("") && !ten.equals("") && !stt.equals("") && loai.equals("") && giaText.equals("")) { //Tên và trạng thái
			dsPhong= phong_DAO.getListPhongByTenVaTrangThai(stt, ten);
		}else if (ma.equals("") && ten.equals("") && stt.equals("") && !loai.equals("") && !giaText.equals("")) { //Giá và loại
			dsPhong= phong_DAO.getListPhongByGiaVaLoai(loai, gia);
		}else if (ma.equals("") && ten.equals("") && !stt.equals("") && loai.equals("") && !giaText.equals("")) { //Giá và trạng thái
			dsPhong= phong_DAO.getListPhongByGiaVaTrangThai(stt, gia);
		}else if (ma.equals("") && ten.equals("") && !stt.equals("") && !loai.equals("") && giaText.equals("")) { //Loại và trạng thái
		...
		}else if (ma.equals("") && ten.equals("") && !stt.equals("") && loai.equals("") && giaText.equals("")) { //Trạng thái
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (o.equals(tblTimKiemPhong)) {
			...
			String giaTmp= doiFormatThanhStringSoThuc(model.getValueAt(row, 3)+ "");
